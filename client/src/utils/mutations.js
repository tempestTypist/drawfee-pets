...
export const ADD_USER = gql`
  mutation addUser($username: String!, $birthday: String!, $email: String!, $password: String!) {
    addUser(username: $username, birthday: $birthday, email: $email, password: $password) {
      token
      user {
        _id
        username
